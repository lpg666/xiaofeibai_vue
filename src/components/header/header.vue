<template>
    <header id="head-top">
        ...
        <router-link to="/news" v-if="userInfo!=null" class="head_news"><img src="../../images/icon_xiaoxi@2x.png"><div v-if="size"><span v-if="size<9 && size>0">{{size}}</span><span v-else>9+</span></div></router-link>
    </header>
</template>
